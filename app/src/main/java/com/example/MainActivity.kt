...
import com.example.presentation.navigation.NavAnimations
import com.example.presentation.screens.add.AddHabitScreen
import com.example.presentation.screens.all.AllHabitsScreen
import com.example.presentation.screens.detail.HabitDetailScreen
...
import com.example.presentation.screens.summary.SummaryScreen
...
import com.example.presentation.navigation.navigateToTopLevelDestination
            ...
            */
            ...
            HabitFlowTheme(darkTheme = darkTheme) {
                ...
                val localizedContext = androidx.compose.runtime.remember(context, appLanguage) {
                    com.example.util.LocaleDirectionHelper.getLocalizedContext(context, appLanguage)
                }
                val direction = com.example.util.LocaleDirectionHelper.getLayoutDirection(appLanguage)
                ...
                androidx.compose.runtime.CompositionLocalProvider(
                    ...
                    com.example.presentation.components.LocalCardAnimationsEnabled provides isCardAnimationsEnabled,
                    com.example.presentation.components.LocalGlassEffectMode provides glassEffectMode
                ) {
                    com.example.presentation.components.CardAnimationClockProvider(
                        enabled = isCardAnimationsEnabled
                    ) {
                        val isRtl = com.example.util.LocaleDirectionHelper.isRtl(appLanguage)
            ...
            try {
                ...
                if (isEnabled) {
                    ...
                    habits.forEach { habit ->
                        if (habit.isActive) {
                            com.example.data.worker.HabitReminderWorker.scheduleHabitReminders(
                                appContext, habit
                            )
                        }
                    }
        ...
        Box(
            ...
            NavHost(
                ...
                composable(route = Routes.CALENDAR) {
                    com.example.presentation.screens.calendar.CalendarScreen(navController = navController)
                }
                composable(route = Routes.NOTIFICATIONS) {
                    com.example.presentation.screens.notifications.NotificationsScreen(navController = navController)
                }
            }
        }
    }
