...
import com.example.overlay.HabitOverlayReceiver
import com.example.overlay.PendingOverlayStore
...
class HabitOverlayWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        if (activeDaysCsv != null && activeDaysCsv.isNotBlank()) {
            ...
            try {
                val db = com.example.data.local.database.HabitDatabase.getDatabase(applicationContext)
