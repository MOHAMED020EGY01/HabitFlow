...
import com.example.widget.util.CircularProgressRingRenderer
import com.example.widget.util.EmptySlotCircleRenderer
import com.example.widget.util.CheckIconRenderer
    ...
    Box(
        ...
        Column(
            ...
            Box(contentAlignment = Alignment.Center) {
                ...
                Text(
                    text = com.example.util.AppFormatters.forceWesternDigits("${habitData.progressPercent.roundToInt()}%"),
                    style = TextStyle(
...
private fun getNextActiveDayLocalized(context: Context, habitData: HabitWidgetRepository.WidgetHabitData, langCode: String): String {
    ...
    val locale = com.example.util.LocaleDirectionHelper.getLocale(langCode)
    val dayName = com.example.util.DayFormatter.getFullDayName(nextActiveDay, locale)
