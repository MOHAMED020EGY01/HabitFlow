...
abstract class HabitDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Fix Issue #2: Missing migration between 7 and 8.
         * Version 8 schema matches version 7 (no structural changes).
         * Implementing this to prevent destructive migration/data loss.
         */
        val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // No changes between 7 and 8
            }
        }
