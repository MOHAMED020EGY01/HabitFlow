...
private fun InactiveHabitsWidgetContent(
    ...
    val isRtl = com.example.core.util.LocaleDirectionHelper.isRtl(langCode)
...
private fun getFormattedStopDate(context: Context, timestamp: Long): String {
    ...
    return context.getString(com.example.R.string.widget_stopped_date, com.example.core.util.AppFormatters.forceWesternDigits(dateStr))
}
...
private fun getDetailedInactiveDuration(context: Context, timestamp: Long): String {
    ...
    return if (isArabic) {
        ...
        com.example.core.util.AppFormatters.forceWesternDigits("متوقفة منذ $durationPart")
    } else {
