...
class HabitWidgetRepository(
    ...
    suspend fun getHabitStatsSummary(): HabitStatsSummary {
        ...
        habits.forEach { habit ->
            ...
            val streak = com.example.core.util.StreakCalculator.calculateStreakFromDates(
        ...
        return HabitStatsSummary(
            ...
            activeCount = habits.count { it.status == com.example.core.model.domain.HabitStatus.ACTIVE },
            inactiveCount = habits.count { it.status == com.example.core.model.domain.HabitStatus.INACTIVE },
            completedCount = habits.count { it.status == com.example.core.model.domain.HabitStatus.COMPLETE },
            failedCount = habits.count { it.status == com.example.core.model.domain.HabitStatus.FAILURE },
