...
class HabitReminderWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        try {
            ...
            android.util.Log.e("HabitReminder", "Failed to initialize app in time", e)
            return Result.retry()
        }
        ...
        if (activeDaysCsv != null && activeDaysCsv.isNotBlank()) {
            ...
            try {
                val db = com.example.core.database.HabitDatabase.getDatabase(context)
        ...
        com.example.core.infrastructure.widget.HabitWidgetSyncUpdater.updateNowForced(context)
        return Result.success()
    }
    ...
    private fun showNotification(habitId: Int, habitName: String) {
        ...
        val notification = NotificationHelper.buildHabitReminderNotification(context, habitId, habitName)
