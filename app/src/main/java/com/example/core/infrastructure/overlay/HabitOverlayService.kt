...
import com.example.core.infrastructure.overlay.composable.HabitOverlayContent
...
class HabitOverlayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Call startForeground immediately to satisfy Android system requirements
        try {
        ...
        serviceScope.launch {
            ...
            // Fix Issue #1: Ensure app is fully initialized before accessing repository or sound engine
            try {
                app.ensureInitialized()
            } catch (e: Exception) {
                android.util.Log.e("HabitOverlay", "Initialization timed out, proceeding with risk", e)
            }
    ...
    private fun startForegroundWithNotification(habitName: String) {
        ...
        val notification = NotificationHelper.buildOverlayServiceNotification(this, habitName)
    ...
    private fun showOverlay(
        ...
        val localizedContext = com.example.core.util.LocaleDirectionHelper.getLocalizedContext(applicationContext, langCode)
        
        // Get a random quote for the overlay
        val quoteProvider = com.example.core.util.MotivationalQuoteProvider(localizedContext)
        ...
        val composeView = ComposeView(localizedContext).apply {
            ...
            setContent {
                val direction = if (com.example.core.util.LocaleDirectionHelper.isRtl(langCode)) {
                ...
                androidx.compose.runtime.CompositionLocalProvider(
                    ...
                    com.example.core.ui.theme.HabitFlowTheme(darkTheme = true) {
                        HabitOverlayContent(
                            habitName  = habitName,
